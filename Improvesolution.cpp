...
// PID controllers
PID pid1(&currentAngle1, &motorSpeed1, &setpoint1, Kp1, Ki1, Kd1, CHANGE);
PID pid2(&currentAngle2, &motorSpeed2, &setpoint2, Kp2, Ki2, Kd2, CHANGE);
PID pid3(&currentAngle3, &motorSpeed3, &setpoint3, Kp3, Ki3, Kd3, CHANGE);
...
const int stepsPerRevolution =  2 * 11 * 30;  // Replace with your encoder's resolution
